  ...
  return (
    <div class="shadow-lg w-[60rem] h-full flex flex-row">
      <div class="h-full flex flex-col justify-evenly items-stretch">
        ...
        <div class="flex flex-col justify-between h-[800px] text-right">
...
function AsignaturasList(props: any){
  ...
  return (
    <section class="min-w-[45rem] w-full py-2 px-7 rounded-lg  max-h-[40rem] overflow-scroll m-16 border-2 border-neutral-300 bg-neutral-100">

      <For each={props.asignaturas()}>{(asignatura: IAsignatura) => 
        <div class="p-2 bg-neutral-300 m-2 rounded-md">
          ...
          <For each={asignatura.secciones}>{seccion => 
            <section 
              ...
              class="bg-slate-200 transition-colors hover:bg-slate-500 p-2 flex"
            >
              ...
              <div>
                <h1 class="font-bold">{asignatura.nombre}-{seccion.numeroSeccion}</h1>
                <div>
                  <details>
                    <summary>Ver clases</summary>
                    <For each={seccion.clases}>{clase => 
                      <section class="bg-red-200 m-1 w-full h-full">
                        <header class="w-full h-min flex">
